...
def generate_molecular_crystals_with_vdw_cutoff_matrix(filename, vdw_matrix, num_structures, Z, volume_mean1, volume_std1, tol1, max_attempts):
    return _pygenarris.generate_molecular_crystals_with_vdw_cutoff_matrix(filename, vdw_matrix, num_structures, Z, volume_mean1, volume_std1, tol1, max_attempts)
